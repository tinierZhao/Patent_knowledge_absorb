...
2. Run the data-preparation scripts to construct citation links, patent-text embeddings, and analytical variables.
...
> Zhao, H., Zhang, G., and Zhang, C. *Highly Cited Prior Patents and Focal Patent Diffusion: The Moderating Role of Disruptiveness.*

## Contact

For questions about the code or replication materials, please contact the corresponding author.
